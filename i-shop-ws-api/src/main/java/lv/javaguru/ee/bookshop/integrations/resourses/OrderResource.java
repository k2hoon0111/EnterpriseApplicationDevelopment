...
public interface OrderResource {
    ...
    static final String UPDATE_ORDER_URL = "/rest/account/{accountId}/order/{orderId}";
    static final String DELETE_ORDER_URL = "/rest/account/{accountId}/order/{orderId}";
    ...
    void updateOrder(Long accountId, Long orderId, OrderDTO orderDTO) throws RestException;

    void deleteOrder(Long accountId, Long orderId) throws RestException;
