...
public interface OrderDetailResource {
    ...
    static final String UPDATE_ORDERDETAIL_URL = "/rest/book/{bookId}/order/{orderId}/orderdetail/{orderDetailId}";
    static final String DELETE_ORDERDETAIL_URL = "/rest/book/{bookId}/order/{orderId}/orderdetail/{orderDetailId}";
    ...
    void updateOrderDetail(Long bookId, Long orderId, Long orderDetailId, OrderDetailDTO orderDetailDTO) throws RestException;

    void deleteOrderDetail(Long bookId, Long orderId, Long orderDetailId) throws RestException;
