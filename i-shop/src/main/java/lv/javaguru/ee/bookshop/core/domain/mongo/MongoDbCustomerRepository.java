...
/**
 * {@link CustomerRepository} implementation using the Spring Data {@link org.springframework.data.mongodb.core.MongoOperations} API.
 *
...
class MongoDbCustomerRepository implements CustomerRepository {
	...
	/**
	 * Creates a new {@link MongoDbCustomerRepository} using the given {@link org.springframework.data.mongodb.core.MongoOperations}.
	 * 
